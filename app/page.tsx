...
export default function Dashboard() {
  ...
  useEffect(() => {
    fetchData();
    // No auto-refresh - data is static from CSV files
  }, []);
            ...
            <div className="mt-6 text-left bg-blue-50 border border-blue-200 rounded-lg p-6">
              ...
              <div className="mt-4 pt-4 border-t border-blue-200">
                <p className="text-xs text-blue-600">
                  📖 This is a prototype version using CSV files. Edit CSV files in <code className="bg-blue-100 px-1 rounded">dummy-data/</code> folder to update data.
                </p>
              </div>
            </div>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mt-8 p-4 bg-blue-50 border border-blue-200 rounded-lg">
          <p className="text-sm text-blue-800">
            <strong>Note:</strong> This dashboard displays data from CSV files in the <code className="bg-blue-100 px-1 rounded">dummy-data/</code> folder. 
            To update data, edit the CSV files and click "Refresh Data" button.
          </p>
        </div>
      </main>
    </div>
